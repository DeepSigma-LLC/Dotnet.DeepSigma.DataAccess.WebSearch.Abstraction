...
/// </summary>
public interface IUrlRetriever<TSearchOptions> where TSearchOptions : class
{
    /// <summary>
    ...
    Task<List<ResponseUrlRetrival>> SearchAsync(string query, TSearchOptions? searchOption = null, CancellationToken cancellationToken = default);
}
